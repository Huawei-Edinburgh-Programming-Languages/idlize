...
export class Deserializer extends DeserializerBase {
    ...
    readCallback_EventType_ParseInfo_Boolean(isSync: boolean = false): Function2<xml_EventType,ParseInfo,boolean> {
    ...
    readCallback_String_String_Boolean(isSync: boolean = false): Function2<string,string,boolean> {
        const _resource : CallbackResource = this.readCallbackResource()
        const _call : KPointer = this.readPointer()
        const _callSync : KPointer = this.readPointer()
    ...
    readCallback_Boolean_Void(isSync: boolean = false): Function1<boolean,void> {
        const _resource : CallbackResource = this.readCallbackResource()
        const _call : KPointer = this.readPointer()
        const _callSync : KPointer = this.readPointer()
...
export function deserializeAndCallCallback_EventType_ParseInfo_Boolean(thisDeserializer: Deserializer) {
    ...
    let _continuation : Function1<boolean,void> = thisDeserializer.readCallback_Boolean_Void(true)
