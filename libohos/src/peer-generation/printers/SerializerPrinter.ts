...
import { generatorConfiguration, Language, isMaterialized, isExternalType, isBuilderClass, throwException, LanguageExpression, isInIdlize, isInIdlizeInternal, createLanguageWriter, lib, LibraryInterface, getExtractorName, getSerializerName, InterfaceConvertor, ProxyConvertor, PrintHint, CppLanguageWriter, isInCurrentModule } from '@idlizer/core'
...
export function createCSerializerPrinter(library: LibraryInterface, language: Language, prefix: string): LanguageWriter {
