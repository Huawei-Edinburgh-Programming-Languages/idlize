...
function createExternalModuleType(library: LibraryInterface, synthesizedEntries: Map<string, idl.IDLEntry>): void {
...
export function fillSyntheticDeclarations(library: LibraryInterface) {
