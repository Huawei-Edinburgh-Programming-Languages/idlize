...
import { processNPrintCXX, processNPrintTS } from "../ost/main";
import { EOL } from "os";

export function dumpTsLike(decls: lw.LWDeclaration[], packages:Set<string>) {
...
export function dumpCLike(decls: lw.LWDeclaration[]) {
...
export function dumpAsIs(decls: lw.LWDeclaration[]) {
    console.log("==================== NATIVE ====================")
    decls.forEach(decl => {
        console.log(processNPrintCXX(decl))
    })
