...
export class NativeModuleEmpty extends NativeModuleEmptyIntegrated implements NativeModule {
    ...
    _LoadVirtualMachine(directory: string, kind: KInt): pointer { throw new Error("unsupported") }
    _RunVirtualMachine(env: pointer, what: KInt, data: KUint8ArrayPtr, length: KInt): KInt { throw new Error("unsupported") }
}