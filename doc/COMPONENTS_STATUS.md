...
|`valueColors`| Function |Morozov Sergey | in progress | devdone on upstream, done on feature branch |https://gitee.com/nikolay-igotti/idlize/issues/IAW4DU|
|`trackBackgroundColor`| Function |Morozov Sergey | done |  |  |
|`strokeWidth`| Function | Morozov Sergey | done |  |  |
|`trackShadow`| Function |Morozov Sergey | in progress | devdone on upstream, done on feature branch |https://gitee.com/nikolay-igotti/idlize/issues/IAW4DU|
