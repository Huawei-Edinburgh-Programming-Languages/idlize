...
|`onAccessibilityHover`| Function | Andrey Khudenkikh, Pavelyev Ivan | in progress | UT in progress Vadim Voronov EVENT |
...
|`onGestureJudgeBegin`| Function | Skroba Gleb, Maksimov Nikita | testskipped | UT in progress Vadim Voronov https://gitee.com/nikolay-igotti/idlize/issues/IAPDBZ EVENT |
|`onGestureRecognizerJudgeBegin`| Function | Skroba Gleb, Maksimov Nikita | testskipped | UT in progress Vadim Voronov https://gitee.com/nikolay-igotti/idlize/issues/IAPDBZ EVENT |
