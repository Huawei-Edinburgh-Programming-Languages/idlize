...
|`setCalendarOptions`| Function | Maksimov Nikita | devdone | UT in progress Kovalev Sergey |
|`showLunar`| Function | Maksimov Nikita | devdone | UT in progress Kovalev Sergey |
|`showHoliday`| Function | Maksimov Nikita | devdone | UT in progress Kovalev Sergey |
|`needSlide`| Function | Maksimov Nikita | done |  |
|`startOfWeek`| Function | Maksimov Nikita | devdone | UT in progress Kovalev Sergey |
|`offDays`| Function | Maksimov Nikita | devdone | UT in progress Kovalev Sergey |
|`direction`| Function | Maksimov Nikita | devdone | UT in progress Kovalev Sergey |
...
|`setFormComponentOptions`| Function | Vadim Voronov | devdone | https://gitee.com/nikolay-igotti/idlize/issues/IB6H50 |
...
|`clip`| Function  | Vadim Voronov | devdone | https://gitee.com/nikolay-igotti/idlize/issues/IB45FO |
|`fill`| Function  | Vadim Voronov | devdone | https://gitee.com/nikolay-igotti/idlize/issues/IB45FO |
...
|`setDirection`| Function  | Vadim Voronov | devdone | https://gitee.com/nikolay-igotti/idlize/issues/IB45FO |
...
|`getStyledString`| Function | Maksimov Nikita | testskipped | UT in progress Maksimov Nikita |
...
|*TabContentTransitionProxy*| *Class* | Dudkin Sergey | UT in progress Dudkin Sergey | |
|`finishTransition`| Function | Dudkin Sergey | testskipped | UT in progress Dudkin Sergey |
|`getFrom`| Function | Dudkin Sergey | testskipped | UT in progress Dudkin Sergey |
|`setFrom`| Function | Dudkin Sergey | testskipped | UT in progress Dudkin Sergey |
|`getTo`| Function | Dudkin Sergey | testskipped | UT in progress Dudkin Sergey |
|`setTo`| Function | Dudkin Sergey | testskipped | UT in progress Dudkin Sergey |
...
|`replaceString`| Function | Maksimov Nikita | testskipped | UT in progress Maksimov Nikita |
|`insertString`| Function | Maksimov Nikita | testskipped | UT in progress Maksimov Nikita |
|`removeString`| Function | Maksimov Nikita | testskipped | UT in progress Maksimov Nikita |
|`replaceStyle`| Function | Maksimov Nikita | in progress | https://gitee.com/nikolay-igotti/idlize/issues/IB4H0N & PixelMap on https://gitee.com/nikolay-igotti/idlize/issues/IAU9UR |
|`setStyle`| Function | Maksimov Nikita | in progress | https://gitee.com/nikolay-igotti/idlize/issues/IB4H0N & PixelMap on https://gitee.com/nikolay-igotti/idlize/issues/IAU9UR |
|`removeStyle`| Function | Maksimov Nikita | testskipped | UT in progress Maksimov Nikita |
|`removeStyles`| Function | Maksimov Nikita | testskipped | UT in progress Maksimov Nikita |
|`clearStyles`| Function | Maksimov Nikita | testskipped | UT in progress Maksimov Nikita |
|`replaceStyledString`| Function | Maksimov Nikita | testskipped | UT in progress Maksimov Nikita |
|`insertStyledString`| Function | Maksimov Nikita | testskipped | UT in progress Maksimov Nikita |
|`appendStyledString`| Function | Maksimov Nikita | testskipped | UT in progress Maksimov Nikita |
