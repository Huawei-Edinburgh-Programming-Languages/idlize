...
export abstract class LanguageWriter {
    ...
    abstract writeMethodDeclaration(name: string, signature: MethodSignature, options?: { modifiers?: MethodModifier[], isDeclared?: boolean, isExport?: boolean, generics?: string[] }): void
