...
1. Optionally, base interface for inheritance  
2. Attributes, which can be provided with *optional* and *static* markers:  
    1. Type  
    2. Name  
3. Methods, which can be provided with a *static* marker:  
    1. Return type  
    2. Name  
