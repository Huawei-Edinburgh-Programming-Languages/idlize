...
void mediaquery_MediaQueryListener_onChangeImpl(OH_NativePointer thisPtr, const OHOS_MEDIAQUERY_mediaquery_CallbackMediaQueryResultVoid* callback_) {
...
void mediaquery_MediaQueryListener_offChangeImpl(OH_NativePointer thisPtr, const Opt_OHOS_MEDIAQUERY_mediaquery_CallbackMediaQueryResultVoid* callback_) {
}
