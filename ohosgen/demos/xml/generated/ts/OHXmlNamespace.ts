...
export namespace xml {
    ...
    export class XmlSerializer implements MaterializedBase {
        ...
        static ctor_xmlserializer(buffer: ArrayBuffer, encoding?: string): KPointer {
...
export namespace xml {
    export class ParseInfoInternal implements MaterializedBase,xml.ParseInfo {
        peer?: Finalizable | undefined
        public getPeer(): Finalizable | undefined {
            return this.peer
        }
...
export namespace xml {
    ...
    export class XmlPullParser implements MaterializedBase {
        ...
        static ctor_xmlpullparser(buffer: ArrayBuffer, encoding?: string): KPointer {
            const thisSerializer: Serializer = Serializer.hold()
            thisSerializer.writeBuffer(buffer)
            let encoding_type: int32 = RuntimeType.UNDEFINED
            encoding_type = runtimeType(encoding)
