...
typedef struct OH_XML_XmlSerializerModifier {
    ...
    void (*setAttributes)(OH_XML_VMContext vmContext, OH_NativePointer thisPtr, const OH_String* name, const OH_String* value);
    void (*addEmptyElement)(OH_XML_VMContext vmContext, OH_NativePointer thisPtr, const OH_String* name);
    void (*setDeclaration)(OH_NativePointer thisPtr);
    void (*startElement)(OH_XML_VMContext vmContext, OH_NativePointer thisPtr, const OH_String* name);
    void (*endElement)(OH_NativePointer thisPtr);
    void (*setNamespace)(OH_XML_VMContext vmContext, OH_NativePointer thisPtr, const OH_String* prefix, const OH_String* namespace_);
    void (*setComment)(OH_XML_VMContext vmContext, OH_NativePointer thisPtr, const OH_String* text);
    void (*setCDATA)(OH_XML_VMContext vmContext, OH_NativePointer thisPtr, const OH_String* text);
    void (*setText)(OH_XML_VMContext vmContext, OH_NativePointer thisPtr, const OH_String* text);
    void (*setDocType)(OH_XML_VMContext vmContext, OH_NativePointer thisPtr, const OH_String* text);
...
typedef struct OH_XML_XmlPullParserModifier {
    ...
    void (*parse)(OH_XML_VMContext vmContext, OH_NativePointer thisPtr, const OH_XML_ParseOptions* option);
    void (*parseXml)(OH_XML_VMContext vmContext, OH_NativePointer thisPtr, const OH_XML_ParseOptions* option);
