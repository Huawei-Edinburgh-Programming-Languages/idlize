...
export default class UIAbilityContext extends Context {
   ...
   * @since 14
   */
  startAbility(want: Want, startAbilityCallback: AsyncCallback<void>): void;
   ...
   * @since 16
   */
  startAbility(want: Want, options: StartOptions, startAbilityCallback: AsyncCallback<void>): void;
