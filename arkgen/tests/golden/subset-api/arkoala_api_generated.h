...
typedef struct AsyncCallbackArrayTextMenuItemArrayTextMenuItem AsyncCallbackArrayTextMenuItemArrayTextMenuItem;
typedef struct Opt_AsyncCallbackArrayTextMenuItemArrayTextMenuItem Opt_AsyncCallbackArrayTextMenuItemArrayTextMenuItem;
typedef struct AsyncCallbackCustomSpanMeasureInfoCustomSpanMetrics AsyncCallbackCustomSpanMeasureInfoCustomSpanMetrics;
typedef struct Opt_AsyncCallbackCustomSpanMeasureInfoCustomSpanMetrics Opt_AsyncCallbackCustomSpanMeasureInfoCustomSpanMetrics;
typedef struct AsyncCallbackTextMenuItemTextRangeBoolean AsyncCallbackTextMenuItemTextRangeBoolean;
typedef struct Opt_AsyncCallbackTextMenuItemTextRangeBoolean Opt_AsyncCallbackTextMenuItemTextRangeBoolean;
...
typedef struct CallbackAreaAreaVoid CallbackAreaAreaVoid;
typedef struct Opt_CallbackAreaAreaVoid Opt_CallbackAreaAreaVoid;
typedef struct CallbackArrayTextMenuItemVoid CallbackArrayTextMenuItemVoid;
typedef struct Opt_CallbackArrayTextMenuItemVoid Opt_CallbackArrayTextMenuItemVoid;
typedef struct CallbackArrayTouchTestInfoTouchResult CallbackArrayTouchTestInfoTouchResult;
typedef struct Opt_CallbackArrayTouchTestInfoTouchResult Opt_CallbackArrayTouchTestInfoTouchResult;
typedef struct CallbackBoolean CallbackBoolean;
typedef struct Opt_CallbackBoolean Opt_CallbackBoolean;
typedef struct CallbackBooleanHoverEventVoid CallbackBooleanHoverEventVoid;
typedef struct Opt_CallbackBooleanHoverEventVoid Opt_CallbackBooleanHoverEventVoid;
typedef struct CallbackBooleanVoid CallbackBooleanVoid;
typedef struct Opt_CallbackBooleanVoid Opt_CallbackBooleanVoid;
typedef struct CallbackClickEventVoid CallbackClickEventVoid;
typedef struct Opt_CallbackClickEventVoid Opt_CallbackClickEventVoid;
typedef struct CallbackCopyEventVoid CallbackCopyEventVoid;
typedef struct Opt_CallbackCopyEventVoid Opt_CallbackCopyEventVoid;
typedef struct CallbackCustomBuilderVoid CallbackCustomBuilderVoid;
typedef struct Opt_CallbackCustomBuilderVoid Opt_CallbackCustomBuilderVoid;
typedef struct CallbackCustomSpanMetricsVoid CallbackCustomSpanMetricsVoid;
typedef struct Opt_CallbackCustomSpanMetricsVoid Opt_CallbackCustomSpanMetricsVoid;
typedef struct CallbackCutEventVoid CallbackCutEventVoid;
typedef struct Opt_CallbackCutEventVoid Opt_CallbackCutEventVoid;
typedef struct CallbackDeleteValueBoolean CallbackDeleteValueBoolean;
typedef struct Opt_CallbackDeleteValueBoolean Opt_CallbackDeleteValueBoolean;
typedef struct CallbackDeleteValueVoid CallbackDeleteValueVoid;
typedef struct Opt_CallbackDeleteValueVoid Opt_CallbackDeleteValueVoid;
typedef struct CallbackDismissContentCoverActionVoid CallbackDismissContentCoverActionVoid;
typedef struct Opt_CallbackDismissContentCoverActionVoid Opt_CallbackDismissContentCoverActionVoid;
typedef struct CallbackDismissDialogActionVoid CallbackDismissDialogActionVoid;
typedef struct Opt_CallbackDismissDialogActionVoid Opt_CallbackDismissDialogActionVoid;
typedef struct CallbackDismissPopupActionVoid CallbackDismissPopupActionVoid;
typedef struct Opt_CallbackDismissPopupActionVoid Opt_CallbackDismissPopupActionVoid;
typedef struct CallbackDismissSheetActionVoid CallbackDismissSheetActionVoid;
typedef struct Opt_CallbackDismissSheetActionVoid Opt_CallbackDismissSheetActionVoid;
typedef struct CallbackDragEventOptStringUnionCustomBuilderDragItemInfo CallbackDragEventOptStringUnionCustomBuilderDragItemInfo;
typedef struct Opt_CallbackDragEventOptStringUnionCustomBuilderDragItemInfo Opt_CallbackDragEventOptStringUnionCustomBuilderDragItemInfo;
typedef struct CallbackDragEventOptStringVoid CallbackDragEventOptStringVoid;
typedef struct Opt_CallbackDragEventOptStringVoid Opt_CallbackDragEventOptStringVoid;
typedef struct CallbackDrawContextCustomSpanDrawInfoVoid CallbackDrawContextCustomSpanDrawInfoVoid;
typedef struct Opt_CallbackDrawContextCustomSpanDrawInfoVoid Opt_CallbackDrawContextCustomSpanDrawInfoVoid;
typedef struct CallbackDrawContextVoid CallbackDrawContextVoid;
typedef struct Opt_CallbackDrawContextVoid Opt_CallbackDrawContextVoid;
typedef struct CallbackFormCallbackInfoVoid CallbackFormCallbackInfoVoid;
typedef struct Opt_CallbackFormCallbackInfoVoid Opt_CallbackFormCallbackInfoVoid;
typedef struct CallbackGestureEventVoid CallbackGestureEventVoid;
typedef struct Opt_CallbackGestureEventVoid Opt_CallbackGestureEventVoid;
typedef struct CallbackGestureInfoBaseGestureEventGestureJudgeResult CallbackGestureInfoBaseGestureEventGestureJudgeResult;
typedef struct Opt_CallbackGestureInfoBaseGestureEventGestureJudgeResult Opt_CallbackGestureInfoBaseGestureEventGestureJudgeResult;
typedef struct CallbackGestureJudgeResultVoid CallbackGestureJudgeResultVoid;
typedef struct Opt_CallbackGestureJudgeResultVoid Opt_CallbackGestureJudgeResultVoid;
typedef struct CallbackGestureRecognizerVoid CallbackGestureRecognizerVoid;
typedef struct Opt_CallbackGestureRecognizerVoid Opt_CallbackGestureRecognizerVoid;
typedef struct CallbackHitTestModeVoid CallbackHitTestModeVoid;
typedef struct Opt_CallbackHitTestModeVoid Opt_CallbackHitTestModeVoid;
typedef struct CallbackInsertValueBoolean CallbackInsertValueBoolean;
typedef struct Opt_CallbackInsertValueBoolean Opt_CallbackInsertValueBoolean;
typedef struct CallbackInsertValueVoid CallbackInsertValueVoid;
typedef struct Opt_CallbackInsertValueVoid Opt_CallbackInsertValueVoid;
typedef struct CallbackItemDragInfoNumberNumberBooleanVoid CallbackItemDragInfoNumberNumberBooleanVoid;
typedef struct Opt_CallbackItemDragInfoNumberNumberBooleanVoid Opt_CallbackItemDragInfoNumberNumberBooleanVoid;
typedef struct CallbackItemDragInfoNumberNumberVoid CallbackItemDragInfoNumberNumberVoid;
typedef struct Opt_CallbackItemDragInfoNumberNumberVoid Opt_CallbackItemDragInfoNumberNumberVoid;
typedef struct CallbackItemDragInfoNumberVoid CallbackItemDragInfoNumberVoid;
typedef struct Opt_CallbackItemDragInfoNumberVoid Opt_CallbackItemDragInfoNumberVoid;
typedef struct CallbackItemDragInfoVoid CallbackItemDragInfoVoid;
typedef struct Opt_CallbackItemDragInfoVoid Opt_CallbackItemDragInfoVoid;
typedef struct CallbackKeyEventBoolean CallbackKeyEventBoolean;
typedef struct Opt_CallbackKeyEventBoolean Opt_CallbackKeyEventBoolean;
typedef struct CallbackKeyEventVoid CallbackKeyEventVoid;
typedef struct Opt_CallbackKeyEventVoid Opt_CallbackKeyEventVoid;
typedef struct CallbackLiteralBooleanIsVisibleVoid CallbackLiteralBooleanIsVisibleVoid;
typedef struct Opt_CallbackLiteralBooleanIsVisibleVoid Opt_CallbackLiteralBooleanIsVisibleVoid;
typedef struct CallbackLiteralNumberOffsetRemainVoid CallbackLiteralNumberOffsetRemainVoid;
typedef struct Opt_CallbackLiteralNumberOffsetRemainVoid Opt_CallbackLiteralNumberOffsetRemainVoid;
typedef struct CallbackMouseEventVoid CallbackMouseEventVoid;
typedef struct Opt_CallbackMouseEventVoid Opt_CallbackMouseEventVoid;
typedef struct CallbackNativeEmbedDataInfoVoid CallbackNativeEmbedDataInfoVoid;
typedef struct Opt_CallbackNativeEmbedDataInfoVoid Opt_CallbackNativeEmbedDataInfoVoid;
typedef struct CallbackNavDestinationContextVoid CallbackNavDestinationContextVoid;
typedef struct Opt_CallbackNavDestinationContextVoid Opt_CallbackNavDestinationContextVoid;
typedef struct CallbackNavigationModeVoid CallbackNavigationModeVoid;
typedef struct Opt_CallbackNavigationModeVoid Opt_CallbackNavigationModeVoid;
typedef struct CallbackNavigationTitleModeVoid CallbackNavigationTitleModeVoid;
typedef struct Opt_CallbackNavigationTitleModeVoid Opt_CallbackNavigationTitleModeVoid;
typedef struct CallbackNavigationTransitionProxyVoid CallbackNavigationTransitionProxyVoid;
typedef struct Opt_CallbackNavigationTransitionProxyVoid Opt_CallbackNavigationTransitionProxyVoid;
typedef struct CallbackNumberBoolean CallbackNumberBoolean;
typedef struct Opt_CallbackNumberBoolean Opt_CallbackNumberBoolean;
typedef struct CallbackNumberNumberBoolean CallbackNumberNumberBoolean;
typedef struct Opt_CallbackNumberNumberBoolean Opt_CallbackNumberNumberBoolean;
typedef struct CallbackNumberNumberNumberVoid CallbackNumberNumberNumberVoid;
typedef struct Opt_CallbackNumberNumberNumberVoid Opt_CallbackNumberNumberNumberVoid;
typedef struct CallbackNumberNumberVoid CallbackNumberNumberVoid;
typedef struct Opt_CallbackNumberNumberVoid Opt_CallbackNumberNumberVoid;
typedef struct CallbackNumberOptBoolean CallbackNumberOptBoolean;
typedef struct Opt_CallbackNumberOptBoolean Opt_CallbackNumberOptBoolean;
typedef struct CallbackNumberScrollStateLiteralNumberOffsetRemain CallbackNumberScrollStateLiteralNumberOffsetRemain;
typedef struct Opt_CallbackNumberScrollStateLiteralNumberOffsetRemain Opt_CallbackNumberScrollStateLiteralNumberOffsetRemain;
typedef struct CallbackNumberVoid CallbackNumberVoid;
typedef struct Opt_CallbackNumberVoid Opt_CallbackNumberVoid;
typedef struct CallbackOffsetResultVoid CallbackOffsetResultVoid;
typedef struct Opt_CallbackOffsetResultVoid Opt_CallbackOffsetResultVoid;
typedef struct CallbackOnHttpErrorReceiveEventVoid CallbackOnHttpErrorReceiveEventVoid;
typedef struct Opt_CallbackOnHttpErrorReceiveEventVoid Opt_CallbackOnHttpErrorReceiveEventVoid;
typedef struct CallbackOnRenderExitedEventVoid CallbackOnRenderExitedEventVoid;
typedef struct Opt_CallbackOnRenderExitedEventVoid Opt_CallbackOnRenderExitedEventVoid;
typedef struct CallbackOnScrollFrameBeginHandlerResultVoid CallbackOnScrollFrameBeginHandlerResultVoid;
typedef struct Opt_CallbackOnScrollFrameBeginHandlerResultVoid Opt_CallbackOnScrollFrameBeginHandlerResultVoid;
typedef struct CallbackOptArrayStringVoid CallbackOptArrayStringVoid;
typedef struct Opt_CallbackOptArrayStringVoid Opt_CallbackOptArrayStringVoid;
typedef struct CallbackOptBooleanVoid CallbackOptBooleanVoid;
typedef struct Opt_CallbackOptBooleanVoid Opt_CallbackOptBooleanVoid;
typedef struct CallbackOptLiteralObjectDetailBoolean CallbackOptLiteralObjectDetailBoolean;
typedef struct Opt_CallbackOptLiteralObjectDetailBoolean Opt_CallbackOptLiteralObjectDetailBoolean;
typedef struct CallbackOptNavigationAnimatedTransitionVoid CallbackOptNavigationAnimatedTransitionVoid;
typedef struct Opt_CallbackOptNavigationAnimatedTransitionVoid Opt_CallbackOptNavigationAnimatedTransitionVoid;
typedef struct CallbackOptStringOptArrayStringVoid CallbackOptStringOptArrayStringVoid;
typedef struct Opt_CallbackOptStringOptArrayStringVoid Opt_CallbackOptStringOptArrayStringVoid;
typedef struct CallbackOptStyledStringOptArrayStringVoid CallbackOptStyledStringOptArrayStringVoid;
typedef struct Opt_CallbackOptStyledStringOptArrayStringVoid Opt_CallbackOptStyledStringOptArrayStringVoid;
typedef struct CallbackOptTypeImageAttributeOnCompleteCallbackEventVoid CallbackOptTypeImageAttributeOnCompleteCallbackEventVoid;
typedef struct Opt_CallbackOptTypeImageAttributeOnCompleteCallbackEventVoid Opt_CallbackOptTypeImageAttributeOnCompleteCallbackEventVoid;
typedef struct CallbackPopInfoVoid CallbackPopInfoVoid;
typedef struct Opt_CallbackPopInfoVoid Opt_CallbackPopInfoVoid;
typedef struct CallbackPreDragStatusVoid CallbackPreDragStatusVoid;
typedef struct Opt_CallbackPreDragStatusVoid Opt_CallbackPreDragStatusVoid;
typedef struct CallbackResourceStrVoid CallbackResourceStrVoid;
typedef struct Opt_CallbackResourceStrVoid Opt_CallbackResourceStrVoid;
typedef struct CallbackRichEditorChangeValueBoolean CallbackRichEditorChangeValueBoolean;
typedef struct Opt_CallbackRichEditorChangeValueBoolean Opt_CallbackRichEditorChangeValueBoolean;
typedef struct CallbackRichEditorDeleteValueBoolean CallbackRichEditorDeleteValueBoolean;
typedef struct Opt_CallbackRichEditorDeleteValueBoolean Opt_CallbackRichEditorDeleteValueBoolean;
typedef struct CallbackRichEditorInsertValueBoolean CallbackRichEditorInsertValueBoolean;
typedef struct Opt_CallbackRichEditorInsertValueBoolean Opt_CallbackRichEditorInsertValueBoolean;
typedef struct CallbackRichEditorRangeVoid CallbackRichEditorRangeVoid;
typedef struct Opt_CallbackRichEditorRangeVoid Opt_CallbackRichEditorRangeVoid;
typedef struct CallbackRichEditorSelectionVoid CallbackRichEditorSelectionVoid;
typedef struct Opt_CallbackRichEditorSelectionVoid Opt_CallbackRichEditorSelectionVoid;
typedef struct CallbackRichEditorTextSpanResultVoid CallbackRichEditorTextSpanResultVoid;
typedef struct Opt_CallbackRichEditorTextSpanResultVoid Opt_CallbackRichEditorTextSpanResultVoid;
typedef struct CallbackSheetDismissVoid CallbackSheetDismissVoid;
typedef struct Opt_CallbackSheetDismissVoid Opt_CallbackSheetDismissVoid;
typedef struct CallbackSheetTypeVoid CallbackSheetTypeVoid;
typedef struct Opt_CallbackSheetTypeVoid Opt_CallbackSheetTypeVoid;
typedef struct CallbackSizeResultVoid CallbackSizeResultVoid;
typedef struct Opt_CallbackSizeResultVoid Opt_CallbackSizeResultVoid;
typedef struct CallbackSpringBackActionVoid CallbackSpringBackActionVoid;
typedef struct Opt_CallbackSpringBackActionVoid Opt_CallbackSpringBackActionVoid;
typedef struct CallbackStringNumberVoid CallbackStringNumberVoid;
typedef struct Opt_CallbackStringNumberVoid Opt_CallbackStringNumberVoid;
typedef struct CallbackStringUnknownVoid CallbackStringUnknownVoid;
typedef struct Opt_CallbackStringUnknownVoid Opt_CallbackStringUnknownVoid;
typedef struct CallbackStringVoid CallbackStringVoid;
typedef struct Opt_CallbackStringVoid Opt_CallbackStringVoid;
typedef struct CallbackStyledStringChangeValueBoolean CallbackStyledStringChangeValueBoolean;
typedef struct Opt_CallbackStyledStringChangeValueBoolean Opt_CallbackStyledStringChangeValueBoolean;
typedef struct CallbackSwipeActionStateVoid CallbackSwipeActionStateVoid;
typedef struct Opt_CallbackSwipeActionStateVoid Opt_CallbackSwipeActionStateVoid;
typedef struct CallbackSwiperContentTransitionProxyVoid CallbackSwiperContentTransitionProxyVoid;
typedef struct Opt_CallbackSwiperContentTransitionProxyVoid Opt_CallbackSwiperContentTransitionProxyVoid;
typedef struct CallbackTerminationInfoVoid CallbackTerminationInfoVoid;
typedef struct Opt_CallbackTerminationInfoVoid Opt_CallbackTerminationInfoVoid;
typedef struct CallbackTextPickerResultVoid CallbackTextPickerResultVoid;
typedef struct Opt_CallbackTextPickerResultVoid Opt_CallbackTextPickerResultVoid;
typedef struct CallbackTextRangeVoid CallbackTextRangeVoid;
typedef struct Opt_CallbackTextRangeVoid Opt_CallbackTextRangeVoid;
typedef struct CallbackTouchEventHitTestMode CallbackTouchEventHitTestMode;
typedef struct Opt_CallbackTouchEventHitTestMode Opt_CallbackTouchEventHitTestMode;
typedef struct CallbackTouchEventVoid CallbackTouchEventVoid;
typedef struct Opt_CallbackTouchEventVoid Opt_CallbackTouchEventVoid;
typedef struct CallbackTouchResultVoid CallbackTouchResultVoid;
typedef struct Opt_CallbackTouchResultVoid Opt_CallbackTouchResultVoid;
typedef struct CallbackUiExtensionProxyVoid CallbackUiExtensionProxyVoid;
typedef struct Opt_CallbackUiExtensionProxyVoid Opt_CallbackUiExtensionProxyVoid;
typedef struct CallbackUnionCustomBuilderDragItemInfoVoid CallbackUnionCustomBuilderDragItemInfoVoid;
typedef struct Opt_CallbackUnionCustomBuilderDragItemInfoVoid Opt_CallbackUnionCustomBuilderDragItemInfoVoid;
typedef struct CallbackUnionNumberArrayNumberVoid CallbackUnionNumberArrayNumberVoid;
typedef struct Opt_CallbackUnionNumberArrayNumberVoid Opt_CallbackUnionNumberArrayNumberVoid;
typedef struct CallbackUnionStringArrayStringUnionNumberArrayNumberVoid CallbackUnionStringArrayStringUnionNumberArrayNumberVoid;
typedef struct Opt_CallbackUnionStringArrayStringUnionNumberArrayNumberVoid Opt_CallbackUnionStringArrayStringUnionNumberArrayNumberVoid;
typedef struct CallbackUnionStringArrayStringVoid CallbackUnionStringArrayStringVoid;
typedef struct Opt_CallbackUnionStringArrayStringVoid Opt_CallbackUnionStringArrayStringVoid;
typedef struct CallbackVoid CallbackVoid;
typedef struct Opt_CallbackVoid Opt_CallbackVoid;
...
typedef struct Ark_Literal_String_value_CallbackVoid_action Ark_Literal_String_value_CallbackVoid_action;
typedef struct Opt_Literal_String_value_CallbackVoid_action Opt_Literal_String_value_CallbackVoid_action;
...
typedef struct Ark_Union_Boolean_CallbackDismissPopupActionVoid Ark_Union_Boolean_CallbackDismissPopupActionVoid;
typedef struct Opt_Union_Boolean_CallbackDismissPopupActionVoid Opt_Union_Boolean_CallbackDismissPopupActionVoid;
...
typedef struct AsyncCallbackArrayTextMenuItemArrayTextMenuItem {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Array_TextMenuItem menuItems, const CallbackArrayTextMenuItemVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Array_TextMenuItem menuItems, const CallbackArrayTextMenuItemVoid continuation);
} AsyncCallbackArrayTextMenuItemArrayTextMenuItem;
typedef struct Opt_AsyncCallbackArrayTextMenuItemArrayTextMenuItem {
    Ark_Tag tag;
    AsyncCallbackArrayTextMenuItemArrayTextMenuItem value;
} Opt_AsyncCallbackArrayTextMenuItemArrayTextMenuItem;
typedef struct AsyncCallbackCustomSpanMeasureInfoCustomSpanMetrics {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_CustomSpanMeasureInfo measureInfo, const CallbackCustomSpanMetricsVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_CustomSpanMeasureInfo measureInfo, const CallbackCustomSpanMetricsVoid continuation);
} AsyncCallbackCustomSpanMeasureInfoCustomSpanMetrics;
typedef struct Opt_AsyncCallbackCustomSpanMeasureInfoCustomSpanMetrics {
    Ark_Tag tag;
    AsyncCallbackCustomSpanMeasureInfoCustomSpanMetrics value;
} Opt_AsyncCallbackCustomSpanMeasureInfoCustomSpanMetrics;
typedef struct AsyncCallbackTextMenuItemTextRangeBoolean {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_TextMenuItem menuItem, const Ark_TextRange range, const CallbackBooleanVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_TextMenuItem menuItem, const Ark_TextRange range, const CallbackBooleanVoid continuation);
} AsyncCallbackTextMenuItemTextRangeBoolean;
typedef struct Opt_AsyncCallbackTextMenuItemTextRangeBoolean {
    Ark_Tag tag;
    AsyncCallbackTextMenuItemTextRangeBoolean value;
} Opt_AsyncCallbackTextMenuItemTextRangeBoolean;
...
typedef struct Callback_onMeasureSize_SizeResult {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_GeometryInfo selfLayoutInfo, const Array_Measurable children, const Ark_ConstraintSizeOptions constraint, const CallbackSizeResultVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_GeometryInfo selfLayoutInfo, const Array_Measurable children, const Ark_ConstraintSizeOptions constraint, const CallbackSizeResultVoid continuation);
...
typedef struct CallbackAreaAreaVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackAreaAreaVoid;
typedef struct Opt_CallbackAreaAreaVoid {
    Ark_Tag tag;
    CallbackAreaAreaVoid value;
} Opt_CallbackAreaAreaVoid;
typedef struct CallbackArrayTextMenuItemVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackArrayTextMenuItemVoid;
typedef struct Opt_CallbackArrayTextMenuItemVoid {
    Ark_Tag tag;
    CallbackArrayTextMenuItemVoid value;
} Opt_CallbackArrayTextMenuItemVoid;
typedef struct CallbackArrayTouchTestInfoTouchResult {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Array_TouchTestInfo value, const CallbackTouchResultVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Array_TouchTestInfo value, const CallbackTouchResultVoid continuation);
} CallbackArrayTouchTestInfoTouchResult;
typedef struct Opt_CallbackArrayTouchTestInfoTouchResult {
    Ark_Tag tag;
    CallbackArrayTouchTestInfoTouchResult value;
} Opt_CallbackArrayTouchTestInfoTouchResult;
typedef struct CallbackBoolean {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const CallbackBooleanVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const CallbackBooleanVoid continuation);
} CallbackBoolean;
typedef struct Opt_CallbackBoolean {
    Ark_Tag tag;
    CallbackBoolean value;
} Opt_CallbackBoolean;
typedef struct CallbackBooleanHoverEventVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackBooleanHoverEventVoid;
typedef struct Opt_CallbackBooleanHoverEventVoid {
    Ark_Tag tag;
    CallbackBooleanHoverEventVoid value;
} Opt_CallbackBooleanHoverEventVoid;
typedef struct CallbackBooleanVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
typedef struct Opt_CallbackBooleanVoid {
    Ark_Tag tag;
    CallbackBooleanVoid value;
} Opt_CallbackBooleanVoid;
typedef struct CallbackClickEventVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackClickEventVoid;
typedef struct Opt_CallbackClickEventVoid {
    Ark_Tag tag;
    CallbackClickEventVoid value;
} Opt_CallbackClickEventVoid;
typedef struct CallbackCopyEventVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackCopyEventVoid;
typedef struct Opt_CallbackCopyEventVoid {
    Ark_Tag tag;
    CallbackCopyEventVoid value;
} Opt_CallbackCopyEventVoid;
typedef struct CallbackCustomBuilderVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackCustomBuilderVoid;
typedef struct Opt_CallbackCustomBuilderVoid {
    Ark_Tag tag;
    CallbackCustomBuilderVoid value;
} Opt_CallbackCustomBuilderVoid;
typedef struct CallbackCustomSpanMetricsVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackCustomSpanMetricsVoid;
typedef struct Opt_CallbackCustomSpanMetricsVoid {
    Ark_Tag tag;
    CallbackCustomSpanMetricsVoid value;
} Opt_CallbackCustomSpanMetricsVoid;
typedef struct CallbackCutEventVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackCutEventVoid;
typedef struct Opt_CallbackCutEventVoid {
    Ark_Tag tag;
    CallbackCutEventVoid value;
} Opt_CallbackCutEventVoid;
typedef struct CallbackDeleteValueBoolean {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_DeleteValue parameter, const CallbackBooleanVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_DeleteValue parameter, const CallbackBooleanVoid continuation);
} CallbackDeleteValueBoolean;
typedef struct Opt_CallbackDeleteValueBoolean {
    Ark_Tag tag;
    CallbackDeleteValueBoolean value;
} Opt_CallbackDeleteValueBoolean;
typedef struct CallbackDeleteValueVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackDeleteValueVoid;
typedef struct Opt_CallbackDeleteValueVoid {
    Ark_Tag tag;
    CallbackDeleteValueVoid value;
} Opt_CallbackDeleteValueVoid;
typedef struct CallbackDismissContentCoverActionVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackDismissContentCoverActionVoid;
typedef struct Opt_CallbackDismissContentCoverActionVoid {
    Ark_Tag tag;
    CallbackDismissContentCoverActionVoid value;
} Opt_CallbackDismissContentCoverActionVoid;
typedef struct CallbackDismissDialogActionVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackDismissDialogActionVoid;
typedef struct Opt_CallbackDismissDialogActionVoid {
    Ark_Tag tag;
    CallbackDismissDialogActionVoid value;
} Opt_CallbackDismissDialogActionVoid;
typedef struct CallbackDismissPopupActionVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackDismissPopupActionVoid;
typedef struct Opt_CallbackDismissPopupActionVoid {
    Ark_Tag tag;
    CallbackDismissPopupActionVoid value;
} Opt_CallbackDismissPopupActionVoid;
typedef struct CallbackDismissSheetActionVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackDismissSheetActionVoid;
typedef struct Opt_CallbackDismissSheetActionVoid {
    Ark_Tag tag;
    CallbackDismissSheetActionVoid value;
} Opt_CallbackDismissSheetActionVoid;
typedef struct CallbackDragEventOptStringUnionCustomBuilderDragItemInfo {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_DragEvent event, const Opt_String extraParams, const CallbackUnionCustomBuilderDragItemInfoVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_DragEvent event, const Opt_String extraParams, const CallbackUnionCustomBuilderDragItemInfoVoid continuation);
} CallbackDragEventOptStringUnionCustomBuilderDragItemInfo;
typedef struct Opt_CallbackDragEventOptStringUnionCustomBuilderDragItemInfo {
    Ark_Tag tag;
    CallbackDragEventOptStringUnionCustomBuilderDragItemInfo value;
} Opt_CallbackDragEventOptStringUnionCustomBuilderDragItemInfo;
typedef struct CallbackDragEventOptStringVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackDragEventOptStringVoid;
typedef struct Opt_CallbackDragEventOptStringVoid {
    Ark_Tag tag;
    CallbackDragEventOptStringVoid value;
} Opt_CallbackDragEventOptStringVoid;
typedef struct CallbackDrawContextCustomSpanDrawInfoVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackDrawContextCustomSpanDrawInfoVoid;
typedef struct Opt_CallbackDrawContextCustomSpanDrawInfoVoid {
    Ark_Tag tag;
    CallbackDrawContextCustomSpanDrawInfoVoid value;
} Opt_CallbackDrawContextCustomSpanDrawInfoVoid;
typedef struct CallbackDrawContextVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackDrawContextVoid;
typedef struct Opt_CallbackDrawContextVoid {
    Ark_Tag tag;
    CallbackDrawContextVoid value;
} Opt_CallbackDrawContextVoid;
typedef struct CallbackFormCallbackInfoVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackFormCallbackInfoVoid;
typedef struct Opt_CallbackFormCallbackInfoVoid {
    Ark_Tag tag;
    CallbackFormCallbackInfoVoid value;
} Opt_CallbackFormCallbackInfoVoid;
typedef struct CallbackGestureEventVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackGestureEventVoid;
typedef struct Opt_CallbackGestureEventVoid {
    Ark_Tag tag;
    CallbackGestureEventVoid value;
} Opt_CallbackGestureEventVoid;
typedef struct CallbackGestureInfoBaseGestureEventGestureJudgeResult {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_GestureInfo gestureInfo, const Ark_BaseGestureEvent event, const CallbackGestureJudgeResultVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_GestureInfo gestureInfo, const Ark_BaseGestureEvent event, const CallbackGestureJudgeResultVoid continuation);
} CallbackGestureInfoBaseGestureEventGestureJudgeResult;
typedef struct Opt_CallbackGestureInfoBaseGestureEventGestureJudgeResult {
    Ark_Tag tag;
    CallbackGestureInfoBaseGestureEventGestureJudgeResult value;
} Opt_CallbackGestureInfoBaseGestureEventGestureJudgeResult;
typedef struct CallbackGestureJudgeResultVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackGestureJudgeResultVoid;
typedef struct Opt_CallbackGestureJudgeResultVoid {
    Ark_Tag tag;
    CallbackGestureJudgeResultVoid value;
} Opt_CallbackGestureJudgeResultVoid;
typedef struct CallbackGestureRecognizerVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackGestureRecognizerVoid;
typedef struct Opt_CallbackGestureRecognizerVoid {
    Ark_Tag tag;
    CallbackGestureRecognizerVoid value;
} Opt_CallbackGestureRecognizerVoid;
typedef struct CallbackHitTestModeVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackHitTestModeVoid;
typedef struct Opt_CallbackHitTestModeVoid {
    Ark_Tag tag;
    CallbackHitTestModeVoid value;
} Opt_CallbackHitTestModeVoid;
typedef struct CallbackInsertValueBoolean {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_InsertValue parameter, const CallbackBooleanVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_InsertValue parameter, const CallbackBooleanVoid continuation);
} CallbackInsertValueBoolean;
typedef struct Opt_CallbackInsertValueBoolean {
    Ark_Tag tag;
    CallbackInsertValueBoolean value;
} Opt_CallbackInsertValueBoolean;
typedef struct CallbackInsertValueVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackInsertValueVoid;
typedef struct Opt_CallbackInsertValueVoid {
    Ark_Tag tag;
    CallbackInsertValueVoid value;
} Opt_CallbackInsertValueVoid;
typedef struct CallbackItemDragInfoNumberNumberBooleanVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackItemDragInfoNumberNumberBooleanVoid;
typedef struct Opt_CallbackItemDragInfoNumberNumberBooleanVoid {
    Ark_Tag tag;
    CallbackItemDragInfoNumberNumberBooleanVoid value;
} Opt_CallbackItemDragInfoNumberNumberBooleanVoid;
typedef struct CallbackItemDragInfoNumberNumberVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackItemDragInfoNumberNumberVoid;
typedef struct Opt_CallbackItemDragInfoNumberNumberVoid {
    Ark_Tag tag;
    CallbackItemDragInfoNumberNumberVoid value;
} Opt_CallbackItemDragInfoNumberNumberVoid;
typedef struct CallbackItemDragInfoNumberVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackItemDragInfoNumberVoid;
typedef struct Opt_CallbackItemDragInfoNumberVoid {
    Ark_Tag tag;
    CallbackItemDragInfoNumberVoid value;
} Opt_CallbackItemDragInfoNumberVoid;
typedef struct CallbackItemDragInfoVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackItemDragInfoVoid;
typedef struct Opt_CallbackItemDragInfoVoid {
    Ark_Tag tag;
    CallbackItemDragInfoVoid value;
} Opt_CallbackItemDragInfoVoid;
typedef struct CallbackKeyEventBoolean {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_KeyEvent parameter, const CallbackBooleanVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_KeyEvent parameter, const CallbackBooleanVoid continuation);
} CallbackKeyEventBoolean;
typedef struct Opt_CallbackKeyEventBoolean {
    Ark_Tag tag;
    CallbackKeyEventBoolean value;
} Opt_CallbackKeyEventBoolean;
typedef struct CallbackKeyEventVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackKeyEventVoid;
typedef struct Opt_CallbackKeyEventVoid {
    Ark_Tag tag;
    CallbackKeyEventVoid value;
} Opt_CallbackKeyEventVoid;
typedef struct CallbackLiteralBooleanIsVisibleVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackLiteralBooleanIsVisibleVoid;
typedef struct Opt_CallbackLiteralBooleanIsVisibleVoid {
    Ark_Tag tag;
    CallbackLiteralBooleanIsVisibleVoid value;
} Opt_CallbackLiteralBooleanIsVisibleVoid;
typedef struct CallbackLiteralNumberOffsetRemainVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackLiteralNumberOffsetRemainVoid;
typedef struct Opt_CallbackLiteralNumberOffsetRemainVoid {
    Ark_Tag tag;
    CallbackLiteralNumberOffsetRemainVoid value;
} Opt_CallbackLiteralNumberOffsetRemainVoid;
typedef struct CallbackMouseEventVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackMouseEventVoid;
typedef struct Opt_CallbackMouseEventVoid {
    Ark_Tag tag;
    CallbackMouseEventVoid value;
} Opt_CallbackMouseEventVoid;
typedef struct CallbackNativeEmbedDataInfoVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackNativeEmbedDataInfoVoid;
typedef struct Opt_CallbackNativeEmbedDataInfoVoid {
    Ark_Tag tag;
    CallbackNativeEmbedDataInfoVoid value;
} Opt_CallbackNativeEmbedDataInfoVoid;
typedef struct CallbackNavDestinationContextVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackNavDestinationContextVoid;
typedef struct Opt_CallbackNavDestinationContextVoid {
    Ark_Tag tag;
    CallbackNavDestinationContextVoid value;
} Opt_CallbackNavDestinationContextVoid;
typedef struct CallbackNavigationModeVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackNavigationModeVoid;
typedef struct Opt_CallbackNavigationModeVoid {
    Ark_Tag tag;
    CallbackNavigationModeVoid value;
} Opt_CallbackNavigationModeVoid;
typedef struct CallbackNavigationTitleModeVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackNavigationTitleModeVoid;
typedef struct Opt_CallbackNavigationTitleModeVoid {
    Ark_Tag tag;
    CallbackNavigationTitleModeVoid value;
} Opt_CallbackNavigationTitleModeVoid;
typedef struct CallbackNavigationTransitionProxyVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackNavigationTransitionProxyVoid;
typedef struct Opt_CallbackNavigationTransitionProxyVoid {
    Ark_Tag tag;
    CallbackNavigationTransitionProxyVoid value;
} Opt_CallbackNavigationTransitionProxyVoid;
typedef struct CallbackNumberBoolean {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number index, const CallbackBooleanVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_Number index, const CallbackBooleanVoid continuation);
} CallbackNumberBoolean;
typedef struct Opt_CallbackNumberBoolean {
    Ark_Tag tag;
    CallbackNumberBoolean value;
} Opt_CallbackNumberBoolean;
typedef struct CallbackNumberNumberBoolean {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number from, const Ark_Number to, const CallbackBooleanVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_Number from, const Ark_Number to, const CallbackBooleanVoid continuation);
} CallbackNumberNumberBoolean;
typedef struct Opt_CallbackNumberNumberBoolean {
    Ark_Tag tag;
    CallbackNumberNumberBoolean value;
} Opt_CallbackNumberNumberBoolean;
typedef struct CallbackNumberNumberNumberVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackNumberNumberNumberVoid;
typedef struct Opt_CallbackNumberNumberNumberVoid {
    Ark_Tag tag;
    CallbackNumberNumberNumberVoid value;
} Opt_CallbackNumberNumberNumberVoid;
typedef struct CallbackNumberNumberVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackNumberNumberVoid;
typedef struct Opt_CallbackNumberNumberVoid {
    Ark_Tag tag;
    CallbackNumberNumberVoid value;
} Opt_CallbackNumberNumberVoid;
typedef struct CallbackNumberOptBoolean {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number a, const CallbackOptBooleanVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_Number a, const CallbackOptBooleanVoid continuation);
} CallbackNumberOptBoolean;
typedef struct Opt_CallbackNumberOptBoolean {
    Ark_Tag tag;
    CallbackNumberOptBoolean value;
} Opt_CallbackNumberOptBoolean;
typedef struct CallbackNumberScrollStateLiteralNumberOffsetRemain {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number offset, Ark_ScrollState state, const CallbackLiteralNumberOffsetRemainVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_Number offset, Ark_ScrollState state, const CallbackLiteralNumberOffsetRemainVoid continuation);
} CallbackNumberScrollStateLiteralNumberOffsetRemain;
typedef struct Opt_CallbackNumberScrollStateLiteralNumberOffsetRemain {
    Ark_Tag tag;
    CallbackNumberScrollStateLiteralNumberOffsetRemain value;
} Opt_CallbackNumberScrollStateLiteralNumberOffsetRemain;
typedef struct CallbackNumberVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
typedef struct Opt_CallbackNumberVoid {
    Ark_Tag tag;
    CallbackNumberVoid value;
} Opt_CallbackNumberVoid;
typedef struct CallbackOffsetResultVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackOffsetResultVoid;
typedef struct Opt_CallbackOffsetResultVoid {
    Ark_Tag tag;
    CallbackOffsetResultVoid value;
} Opt_CallbackOffsetResultVoid;
typedef struct CallbackOnHttpErrorReceiveEventVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackOnHttpErrorReceiveEventVoid;
typedef struct Opt_CallbackOnHttpErrorReceiveEventVoid {
    Ark_Tag tag;
    CallbackOnHttpErrorReceiveEventVoid value;
} Opt_CallbackOnHttpErrorReceiveEventVoid;
typedef struct CallbackOnRenderExitedEventVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackOnRenderExitedEventVoid;
typedef struct Opt_CallbackOnRenderExitedEventVoid {
    Ark_Tag tag;
    CallbackOnRenderExitedEventVoid value;
} Opt_CallbackOnRenderExitedEventVoid;
typedef struct CallbackOnScrollFrameBeginHandlerResultVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackOnScrollFrameBeginHandlerResultVoid;
typedef struct Opt_CallbackOnScrollFrameBeginHandlerResultVoid {
    Ark_Tag tag;
    CallbackOnScrollFrameBeginHandlerResultVoid value;
} Opt_CallbackOnScrollFrameBeginHandlerResultVoid;
typedef struct CallbackOptArrayStringVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackOptArrayStringVoid;
typedef struct Opt_CallbackOptArrayStringVoid {
    Ark_Tag tag;
    CallbackOptArrayStringVoid value;
} Opt_CallbackOptArrayStringVoid;
typedef struct CallbackOptBooleanVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackOptBooleanVoid;
typedef struct Opt_CallbackOptBooleanVoid {
    Ark_Tag tag;
    CallbackOptBooleanVoid value;
} Opt_CallbackOptBooleanVoid;
typedef struct CallbackOptLiteralObjectDetailBoolean {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Opt_Literal_Object_detail event, const CallbackBooleanVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Opt_Literal_Object_detail event, const CallbackBooleanVoid continuation);
} CallbackOptLiteralObjectDetailBoolean;
typedef struct Opt_CallbackOptLiteralObjectDetailBoolean {
    Ark_Tag tag;
    CallbackOptLiteralObjectDetailBoolean value;
} Opt_CallbackOptLiteralObjectDetailBoolean;
typedef struct CallbackOptNavigationAnimatedTransitionVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackOptNavigationAnimatedTransitionVoid;
typedef struct Opt_CallbackOptNavigationAnimatedTransitionVoid {
    Ark_Tag tag;
    CallbackOptNavigationAnimatedTransitionVoid value;
} Opt_CallbackOptNavigationAnimatedTransitionVoid;
typedef struct CallbackOptStringOptArrayStringVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackOptStringOptArrayStringVoid;
typedef struct Opt_CallbackOptStringOptArrayStringVoid {
    Ark_Tag tag;
    CallbackOptStringOptArrayStringVoid value;
} Opt_CallbackOptStringOptArrayStringVoid;
typedef struct CallbackOptStyledStringOptArrayStringVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackOptStyledStringOptArrayStringVoid;
typedef struct Opt_CallbackOptStyledStringOptArrayStringVoid {
    Ark_Tag tag;
    CallbackOptStyledStringOptArrayStringVoid value;
} Opt_CallbackOptStyledStringOptArrayStringVoid;
typedef struct CallbackOptTypeImageAttributeOnCompleteCallbackEventVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackOptTypeImageAttributeOnCompleteCallbackEventVoid;
typedef struct Opt_CallbackOptTypeImageAttributeOnCompleteCallbackEventVoid {
    Ark_Tag tag;
    CallbackOptTypeImageAttributeOnCompleteCallbackEventVoid value;
} Opt_CallbackOptTypeImageAttributeOnCompleteCallbackEventVoid;
typedef struct CallbackPopInfoVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
typedef struct Opt_CallbackPopInfoVoid {
    Ark_Tag tag;
    CallbackPopInfoVoid value;
} Opt_CallbackPopInfoVoid;
typedef struct CallbackPreDragStatusVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackPreDragStatusVoid;
typedef struct Opt_CallbackPreDragStatusVoid {
    Ark_Tag tag;
    CallbackPreDragStatusVoid value;
} Opt_CallbackPreDragStatusVoid;
typedef struct CallbackResourceStrVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackResourceStrVoid;
typedef struct Opt_CallbackResourceStrVoid {
    Ark_Tag tag;
    CallbackResourceStrVoid value;
} Opt_CallbackResourceStrVoid;
typedef struct CallbackRichEditorChangeValueBoolean {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_RichEditorChangeValue parameter, const CallbackBooleanVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_RichEditorChangeValue parameter, const CallbackBooleanVoid continuation);
} CallbackRichEditorChangeValueBoolean;
typedef struct Opt_CallbackRichEditorChangeValueBoolean {
    Ark_Tag tag;
    CallbackRichEditorChangeValueBoolean value;
} Opt_CallbackRichEditorChangeValueBoolean;
typedef struct CallbackRichEditorDeleteValueBoolean {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_RichEditorDeleteValue parameter, const CallbackBooleanVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_RichEditorDeleteValue parameter, const CallbackBooleanVoid continuation);
} CallbackRichEditorDeleteValueBoolean;
typedef struct Opt_CallbackRichEditorDeleteValueBoolean {
    Ark_Tag tag;
    CallbackRichEditorDeleteValueBoolean value;
} Opt_CallbackRichEditorDeleteValueBoolean;
typedef struct CallbackRichEditorInsertValueBoolean {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_RichEditorInsertValue parameter, const CallbackBooleanVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_RichEditorInsertValue parameter, const CallbackBooleanVoid continuation);
} CallbackRichEditorInsertValueBoolean;
typedef struct Opt_CallbackRichEditorInsertValueBoolean {
    Ark_Tag tag;
    CallbackRichEditorInsertValueBoolean value;
} Opt_CallbackRichEditorInsertValueBoolean;
typedef struct CallbackRichEditorRangeVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackRichEditorRangeVoid;
typedef struct Opt_CallbackRichEditorRangeVoid {
    Ark_Tag tag;
    CallbackRichEditorRangeVoid value;
} Opt_CallbackRichEditorRangeVoid;
typedef struct CallbackRichEditorSelectionVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackRichEditorSelectionVoid;
typedef struct Opt_CallbackRichEditorSelectionVoid {
    Ark_Tag tag;
    CallbackRichEditorSelectionVoid value;
} Opt_CallbackRichEditorSelectionVoid;
typedef struct CallbackRichEditorTextSpanResultVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackRichEditorTextSpanResultVoid;
typedef struct Opt_CallbackRichEditorTextSpanResultVoid {
    Ark_Tag tag;
    CallbackRichEditorTextSpanResultVoid value;
} Opt_CallbackRichEditorTextSpanResultVoid;
typedef struct CallbackSheetDismissVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackSheetDismissVoid;
typedef struct Opt_CallbackSheetDismissVoid {
    Ark_Tag tag;
    CallbackSheetDismissVoid value;
} Opt_CallbackSheetDismissVoid;
typedef struct CallbackSheetTypeVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackSheetTypeVoid;
typedef struct Opt_CallbackSheetTypeVoid {
    Ark_Tag tag;
    CallbackSheetTypeVoid value;
} Opt_CallbackSheetTypeVoid;
typedef struct CallbackSizeResultVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackSizeResultVoid;
typedef struct Opt_CallbackSizeResultVoid {
    Ark_Tag tag;
    CallbackSizeResultVoid value;
} Opt_CallbackSizeResultVoid;
typedef struct CallbackSpringBackActionVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackSpringBackActionVoid;
typedef struct Opt_CallbackSpringBackActionVoid {
    Ark_Tag tag;
    CallbackSpringBackActionVoid value;
} Opt_CallbackSpringBackActionVoid;
typedef struct CallbackStringNumberVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackStringNumberVoid;
typedef struct Opt_CallbackStringNumberVoid {
    Ark_Tag tag;
    CallbackStringNumberVoid value;
} Opt_CallbackStringNumberVoid;
typedef struct CallbackStringUnknownVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackStringUnknownVoid;
typedef struct Opt_CallbackStringUnknownVoid {
    Ark_Tag tag;
    CallbackStringUnknownVoid value;
} Opt_CallbackStringUnknownVoid;
typedef struct CallbackStringVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
typedef struct Opt_CallbackStringVoid {
    Ark_Tag tag;
    CallbackStringVoid value;
} Opt_CallbackStringVoid;
typedef struct CallbackStyledStringChangeValueBoolean {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_StyledStringChangeValue parameter, const CallbackBooleanVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_StyledStringChangeValue parameter, const CallbackBooleanVoid continuation);
} CallbackStyledStringChangeValueBoolean;
typedef struct Opt_CallbackStyledStringChangeValueBoolean {
    Ark_Tag tag;
    CallbackStyledStringChangeValueBoolean value;
} Opt_CallbackStyledStringChangeValueBoolean;
typedef struct CallbackSwipeActionStateVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackSwipeActionStateVoid;
typedef struct Opt_CallbackSwipeActionStateVoid {
    Ark_Tag tag;
    CallbackSwipeActionStateVoid value;
} Opt_CallbackSwipeActionStateVoid;
typedef struct CallbackSwiperContentTransitionProxyVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackSwiperContentTransitionProxyVoid;
typedef struct Opt_CallbackSwiperContentTransitionProxyVoid {
    Ark_Tag tag;
    CallbackSwiperContentTransitionProxyVoid value;
} Opt_CallbackSwiperContentTransitionProxyVoid;
typedef struct CallbackTerminationInfoVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackTerminationInfoVoid;
typedef struct Opt_CallbackTerminationInfoVoid {
    Ark_Tag tag;
    CallbackTerminationInfoVoid value;
} Opt_CallbackTerminationInfoVoid;
typedef struct CallbackTextPickerResultVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackTextPickerResultVoid;
typedef struct Opt_CallbackTextPickerResultVoid {
    Ark_Tag tag;
    CallbackTextPickerResultVoid value;
} Opt_CallbackTextPickerResultVoid;
typedef struct CallbackTextRangeVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackTextRangeVoid;
typedef struct Opt_CallbackTextRangeVoid {
    Ark_Tag tag;
    CallbackTextRangeVoid value;
} Opt_CallbackTextRangeVoid;
typedef struct CallbackTouchEventHitTestMode {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_TouchEvent parameter, const CallbackHitTestModeVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_TouchEvent parameter, const CallbackHitTestModeVoid continuation);
} CallbackTouchEventHitTestMode;
typedef struct Opt_CallbackTouchEventHitTestMode {
    Ark_Tag tag;
    CallbackTouchEventHitTestMode value;
} Opt_CallbackTouchEventHitTestMode;
typedef struct CallbackTouchEventVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackTouchEventVoid;
typedef struct Opt_CallbackTouchEventVoid {
    Ark_Tag tag;
    CallbackTouchEventVoid value;
} Opt_CallbackTouchEventVoid;
typedef struct CallbackTouchResultVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackTouchResultVoid;
typedef struct Opt_CallbackTouchResultVoid {
    Ark_Tag tag;
    CallbackTouchResultVoid value;
} Opt_CallbackTouchResultVoid;
typedef struct CallbackUiExtensionProxyVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackUiExtensionProxyVoid;
typedef struct Opt_CallbackUiExtensionProxyVoid {
    Ark_Tag tag;
    CallbackUiExtensionProxyVoid value;
} Opt_CallbackUiExtensionProxyVoid;
typedef struct CallbackUnionCustomBuilderDragItemInfoVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackUnionCustomBuilderDragItemInfoVoid;
typedef struct Opt_CallbackUnionCustomBuilderDragItemInfoVoid {
    Ark_Tag tag;
    CallbackUnionCustomBuilderDragItemInfoVoid value;
} Opt_CallbackUnionCustomBuilderDragItemInfoVoid;
typedef struct CallbackUnionNumberArrayNumberVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackUnionNumberArrayNumberVoid;
typedef struct Opt_CallbackUnionNumberArrayNumberVoid {
    Ark_Tag tag;
    CallbackUnionNumberArrayNumberVoid value;
} Opt_CallbackUnionNumberArrayNumberVoid;
typedef struct CallbackUnionStringArrayStringUnionNumberArrayNumberVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackUnionStringArrayStringUnionNumberArrayNumberVoid;
typedef struct Opt_CallbackUnionStringArrayStringUnionNumberArrayNumberVoid {
    Ark_Tag tag;
    CallbackUnionStringArrayStringUnionNumberArrayNumberVoid value;
} Opt_CallbackUnionStringArrayStringUnionNumberArrayNumberVoid;
typedef struct CallbackUnionStringArrayStringVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
...
} CallbackUnionStringArrayStringVoid;
typedef struct Opt_CallbackUnionStringArrayStringVoid {
    Ark_Tag tag;
    CallbackUnionStringArrayStringVoid value;
} Opt_CallbackUnionStringArrayStringVoid;
typedef struct CallbackVoid {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId);
} CallbackVoid;
typedef struct Opt_CallbackVoid {
    Ark_Tag tag;
    CallbackVoid value;
} Opt_CallbackVoid;
...
typedef struct GestureRecognizerJudgeBeginCallback {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_BaseGestureEvent event, const Ark_GestureRecognizer current, const Array_GestureRecognizer recognizers, const CallbackGestureJudgeResultVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_BaseGestureEvent event, const Ark_GestureRecognizer current, const Array_GestureRecognizer recognizers, const CallbackGestureJudgeResultVoid continuation);
...
typedef struct ListAttribute_onItemDragStart_event_type {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_ItemDragInfo event, const Ark_Number itemIndex, const CallbackCustomBuilderVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_ItemDragInfo event, const Ark_Number itemIndex, const CallbackCustomBuilderVoid continuation);
...
typedef struct OnScrollFrameBeginCallback {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number offset, Ark_ScrollState state, const CallbackOnScrollFrameBeginHandlerResultVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_Number offset, Ark_ScrollState state, const CallbackOnScrollFrameBeginHandlerResultVoid continuation);
...
typedef struct ScrollOnWillScrollCallback {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_Number xOffset, const Ark_Number yOffset, Ark_ScrollState scrollState, Ark_ScrollSource scrollSource, const CallbackOffsetResultVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_Number xOffset, const Ark_Number yOffset, Ark_ScrollState scrollState, Ark_ScrollSource scrollSource, const CallbackOffsetResultVoid continuation);
...
typedef struct ShouldBuiltInRecognizerParallelWithCallback {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_GestureRecognizer current, const Array_GestureRecognizer others, const CallbackGestureRecognizerVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_GestureRecognizer current, const Array_GestureRecognizer others, const CallbackGestureRecognizerVoid continuation);
...
typedef struct Type_NavigationAttribute_customNavContentTransition_delegate {
    /* kind: Callback */
    Ark_CallbackResource resource;
    void (*call)(const Ark_Int32 resourceId, const Ark_NavContentInfo from, const Ark_NavContentInfo to, Ark_NavigationOperation operation, const CallbackOptNavigationAnimatedTransitionVoid continuation);
    void (*callSync)(Ark_VMContext vmContext, const Ark_Int32 resourceId, const Ark_NavContentInfo from, const Ark_NavContentInfo to, Ark_NavigationOperation operation, const CallbackOptNavigationAnimatedTransitionVoid continuation);
...
typedef struct Ark_CopyEvent {
    /* kind: Interface */
    Opt_CallbackVoid preventDefault;
} Ark_CopyEvent;
...
typedef struct Ark_EditMenuOptions {
    /* kind: Interface */
    AsyncCallbackArrayTextMenuItemArrayTextMenuItem onCreateMenu;
    AsyncCallbackTextMenuItemTextRangeBoolean onMenuItemClick;
} Ark_EditMenuOptions;
...
typedef struct Ark_GestureStyleInterface {
    /* kind: Interface */
    Opt_CallbackClickEventVoid onClick;
    Opt_CallbackGestureEventVoid onLongPress;
...
typedef struct Ark_Literal_String_value_CallbackVoid_action {
    /* kind: Interface */
    Ark_String value;
    CallbackVoid action;
} Ark_Literal_String_value_CallbackVoid_action;
typedef struct Opt_Literal_String_value_CallbackVoid_action {
    Ark_Tag tag;
    Ark_Literal_String_value_CallbackVoid_action value;
} Opt_Literal_String_value_CallbackVoid_action;
...
typedef struct Ark_NavigationAnimatedTransition {
    /* kind: Interface */
    Opt_CallbackBooleanVoid onTransitionEnd;
    Opt_Number timeout;
    Opt_Boolean isInteractive;
    CallbackNavigationTransitionProxyVoid transition;
...
typedef struct Ark_StyledStringChangedListener {
    /* kind: Interface */
    Opt_CallbackStyledStringChangeValueBoolean onWillChange;
...
typedef struct Ark_SwiperContentAnimatedTransition {
    /* kind: Interface */
    Opt_Number timeout;
    CallbackSwiperContentTransitionProxyVoid transition;
...
typedef struct Ark_Union_Boolean_CallbackDismissPopupActionVoid {
    /* kind: UnionType */
    Ark_Int32 selector;
    union {
        Ark_Boolean value0;
        CallbackDismissPopupActionVoid value1;
    };
} Ark_Union_Boolean_CallbackDismissPopupActionVoid;
typedef struct Opt_Union_Boolean_CallbackDismissPopupActionVoid {
    Ark_Tag tag;
    Ark_Union_Boolean_CallbackDismissPopupActionVoid value;
} Opt_Union_Boolean_CallbackDismissPopupActionVoid;
...
typedef struct Ark_ContentCoverOptions {
    /* kind: Interface */
    Opt_ResourceColor backgroundColor;
    Opt_CallbackVoid onAppear;
    Opt_CallbackVoid onDisappear;
    Opt_CallbackVoid onWillAppear;
    Opt_CallbackVoid onWillDisappear;
    Opt_ModalTransition modalTransition;
    Opt_CallbackDismissContentCoverActionVoid onWillDismiss;
...
typedef struct Ark_SwipeActionItem {
    ...
    Opt_CallbackVoid onAction;
    Opt_CallbackVoid onEnterActionArea;
    Opt_CallbackVoid onExitActionArea;
    Opt_CallbackSwipeActionStateVoid onStateChange;
} Ark_SwipeActionItem;
...
typedef struct Ark_AlertDialogParamWithButtons {
    ...
    Opt_ResourceColor backgroundColor;
    Opt_BlurStyle backgroundBlurStyle;
    Opt_CallbackDismissDialogActionVoid onWillDismiss;
    Opt_TransitionEffect transition;
...
typedef struct Ark_ContextMenuOptions {
    ...
    Opt_CallbackVoid onAppear;
    Opt_CallbackVoid onDisappear;
    Opt_CallbackVoid aboutToAppear;
    Opt_CallbackVoid aboutToDisappear;
...
typedef struct Ark_CustomPopupOptions {
    ...
    Opt_Boolean enableArrow;
    Opt_Boolean autoCancel;
    Opt_CallbackLiteralBooleanIsVisibleVoid onStateChange;
    Opt_Length arrowOffset;
    Opt_Boolean showInSubWindow;
    ...
    Opt_TransitionEffect transition;
    Opt_Union_Boolean_CallbackDismissPopupActionVoid onWillDismiss;
    Opt_Boolean enableHoverMode;
...
typedef struct Ark_SheetOptions {
    ...
    Opt_CallbackSheetDismissVoid shouldDismiss;
    Opt_CallbackDismissSheetActionVoid onWillDismiss;
    Opt_CallbackSpringBackActionVoid onWillSpringBackWhenDismiss;
    ...
    Opt_Union_BorderStyle_EdgeStyles borderStyle;
    Opt_Union_ShadowOptions_ShadowStyle shadow;
    Opt_CallbackNumberVoid onHeightDidChange;
    Opt_SheetMode mode;
    Opt_ScrollSizeMode scrollSizeMode;
    Opt_CallbackNumberVoid onDetentsDidChange;
    Opt_CallbackNumberVoid onWidthDidChange;
    Opt_CallbackSheetTypeVoid onTypeDidChange;
...
typedef struct Ark_SwipeActionOptions {
    ...
    Opt_CallbackNumberVoid onOffsetChange;
...
typedef struct Ark_TextDataDetectorConfig {
    ...
    Opt_CallbackStringVoid onDetectResultUpdate;
    Opt_ResourceColor color;
    Opt_DecorationStyleInterface decoration;
...
typedef struct Ark_PopupOptions {
    ...
    Opt_Placement placement;
    Opt_Literal_String_value_CallbackVoid_action primaryButton;
    Opt_Literal_String_value_CallbackVoid_action secondaryButton;
    Opt_CallbackLiteralBooleanIsVisibleVoid onStateChange;
    Opt_Length arrowOffset;
    Opt_Boolean showInSubWindow;
    Opt_Union_Boolean_Literal_ResourceColor_color mask;
...
typedef struct Ark_TextPickerDialogOptions {
    ...
    Opt_CallbackTextPickerResultVoid onAccept;
    Opt_CallbackVoid onCancel;
    Opt_CallbackTextPickerResultVoid onChange;
    Opt_CallbackTextPickerResultVoid onScrollStop;
    Opt_Rectangle maskRect;
    Opt_DialogAlignment alignment;
    Opt_Offset offset;
    Opt_ResourceColor backgroundColor;
    Opt_BlurStyle backgroundBlurStyle;
    Opt_CallbackVoid onDidAppear;
    Opt_CallbackVoid onDidDisappear;
    Opt_CallbackVoid onWillAppear;
    Opt_CallbackVoid onWillDisappear;
    Opt_Union_ShadowOptions_ShadowStyle shadow;
    Opt_Boolean enableHoverMode;
...
typedef struct GENERATED_ArkUICommonMethodModifier {
    ...
    void (*setOnChildTouchTest)(Ark_NativePointer node,
                                const Opt_CallbackArrayTouchTestInfoTouchResult* event);
    ...
    void (*setOnHover)(Ark_NativePointer node,
                       const Opt_CallbackBooleanHoverEventVoid* event);
    ...
    void (*setOnMouse)(Ark_NativePointer node,
                       const Opt_CallbackMouseEventVoid* event);
    void (*setOnTouch)(Ark_NativePointer node,
                       const Opt_CallbackTouchEventVoid* event);
    void (*setOnKeyEvent)(Ark_NativePointer node,
                          const Opt_CallbackKeyEventVoid* event);
    void (*setOnKeyPreIme)(Ark_NativePointer node,
                           const Opt_CallbackKeyEventBoolean* event);
    ...
    void (*setOnDragStart)(Ark_NativePointer node,
                           const Opt_CallbackDragEventOptStringUnionCustomBuilderDragItemInfo* event);
    void (*setOnDragEnter)(Ark_NativePointer node,
                           const Opt_CallbackDragEventOptStringVoid* event);
    ...
    void (*setOnPreDrag)(Ark_NativePointer node,
                         const Opt_CallbackPreDragStatusVoid* callback_);
    ...
    void (*setOnGestureJudgeBegin)(Ark_NativePointer node,
                                   const Opt_CallbackGestureInfoBaseGestureEventGestureJudgeResult* callback_);
    ...
    void (*setOnTouchIntercept)(Ark_NativePointer node,
                                const Opt_CallbackTouchEventHitTestMode* callback_);
...
typedef struct GENERATED_ArkUIEmbeddedComponentModifier {
    ...
    void (*setOnTerminated)(Ark_NativePointer node,
                            const Opt_CallbackTerminationInfoVoid* callback_);
...
typedef struct GENERATED_ArkUIFormComponentModifier {
    ...
    void (*setOnAcquired)(Ark_NativePointer node,
                          const Opt_CallbackFormCallbackInfoVoid* callback_);
...
typedef struct GENERATED_ArkUIGridModifier {
    ...
    void (*setOnScrollIndex)(Ark_NativePointer node,
                             const Opt_CallbackNumberNumberVoid* event);
...
typedef struct GENERATED_ArkUIGridItemModifier {
    ...
    void (*setOnSelect)(Ark_NativePointer node,
                        const Opt_CallbackBooleanVoid* event);
    void (*set_onChangeEvent_selected)(Ark_NativePointer node,
                                       const CallbackNumberVoid* callback);
...
typedef struct GENERATED_ArkUIImageModifier {
    ...
    void (*setOnComplete)(Ark_NativePointer node,
                          const Opt_CallbackOptTypeImageAttributeOnCompleteCallbackEventVoid* callback_);
    void (*setOnError)(Ark_NativePointer node,
...
typedef struct GENERATED_ArkUIIndicatorComponentModifier {
    ...
    void (*setOnChange)(Ark_NativePointer node,
                        const Opt_CallbackNumberVoid* event);
...
typedef struct GENERATED_ArkUIListModifier {
    ...
    void (*setOnScrollIndex)(Ark_NativePointer node,
                             const Opt_CallbackNumberNumberNumberVoid* event);
    ...
    void (*setOnItemDelete)(Ark_NativePointer node,
                            const Opt_CallbackNumberBoolean* event);
    void (*setOnItemMove)(Ark_NativePointer node,
                          const Opt_CallbackNumberNumberBoolean* event);
    ...
    void (*setOnItemDragEnter)(Ark_NativePointer node,
                               const Opt_CallbackItemDragInfoVoid* event);
    void (*setOnItemDragMove)(Ark_NativePointer node,
                              const Opt_CallbackItemDragInfoNumberNumberVoid* event);
    void (*setOnItemDragLeave)(Ark_NativePointer node,
                               const Opt_CallbackItemDragInfoNumberVoid* event);
    void (*setOnItemDrop)(Ark_NativePointer node,
                          const Opt_CallbackItemDragInfoNumberNumberBooleanVoid* event);
    void (*setOnScrollFrameBegin)(Ark_NativePointer node,
                                  const Opt_CallbackNumberScrollStateLiteralNumberOffsetRemain* event);
...
typedef struct GENERATED_ArkUINavDestinationModifier {
    ...
    void (*setOnBackPressed)(Ark_NativePointer node,
                             const Opt_CallbackBoolean* callback_);
    ...
    void (*setOnReady)(Ark_NativePointer node,
                       const Opt_CallbackNavDestinationContextVoid* callback_);
...
typedef struct GENERATED_ArkUINavigationModifier {
    ...
    void (*setOnTitleModeChange)(Ark_NativePointer node,
                                 const Opt_CallbackNavigationTitleModeVoid* callback_);
    void (*setOnNavBarStateChange)(Ark_NativePointer node,
                                   const Opt_CallbackBooleanVoid* callback_);
    void (*setOnNavigationModeChange)(Ark_NativePointer node,
                                      const Opt_CallbackNavigationModeVoid* callback_);
    void (*setNavDestination)(Ark_NativePointer node,
                              const Opt_CallbackStringUnknownVoid* builder);
...
typedef struct GENERATED_ArkUIRichEditorModifier {
    ...
    void (*setOnReady)(Ark_NativePointer node,
                       const Opt_CallbackVoid* callback_);
    void (*setOnSelect)(Ark_NativePointer node,
                        const Opt_CallbackRichEditorSelectionVoid* callback_);
    void (*setOnSelectionChange)(Ark_NativePointer node,
                                 const Opt_CallbackRichEditorRangeVoid* callback_);
    void (*setAboutToIMEInput)(Ark_NativePointer node,
                               const Opt_CallbackRichEditorInsertValueBoolean* callback_);
    void (*setOnIMEInputComplete)(Ark_NativePointer node,
                                  const Opt_CallbackRichEditorTextSpanResultVoid* callback_);
    void (*setOnDidIMEInput)(Ark_NativePointer node,
                             const Opt_CallbackTextRangeVoid* callback_);
    void (*setAboutToDelete)(Ark_NativePointer node,
                             const Opt_CallbackRichEditorDeleteValueBoolean* callback_);
...
typedef struct GENERATED_ArkUISearchModifier {
    ...
    void (*setInputFilter)(Ark_NativePointer node,
                           const Opt_ResourceStr* value,
                           const Opt_CallbackStringVoid* error);
    ...
    void (*setOnCopy)(Ark_NativePointer node,
                      const Opt_CallbackStringVoid* callback_);
    void (*setOnCut)(Ark_NativePointer node,
                     const Opt_CallbackStringVoid* callback_);
    void (*setOnPaste)(Ark_NativePointer node,
    ...
    void (*setOnWillInsert)(Ark_NativePointer node,
                            const Opt_CallbackInsertValueBoolean* callback_);
    void (*setOnDidInsert)(Ark_NativePointer node,
                           const Opt_CallbackInsertValueVoid* callback_);
    void (*setOnWillDelete)(Ark_NativePointer node,
                            const Opt_CallbackDeleteValueBoolean* callback_);
    void (*setOnDidDelete)(Ark_NativePointer node,
                           const Opt_CallbackDeleteValueVoid* callback_);
    void (*setEditMenuOptions)(Ark_NativePointer node,
                               const Opt_EditMenuOptions* editMenu);
    void (*setEnablePreviewText)(Ark_NativePointer node,
                                 const Opt_Boolean* enable);
    ...
    void (*set_onChangeEvent_value)(Ark_NativePointer node,
                                    const CallbackStringVoid* callback);
...
typedef struct GENERATED_ArkUITest1Modifier {
    ...
    void (*setTestFunction)(Ark_NativePointer node,
                            const Opt_CallbackNumberBoolean* value);
    ...
    void (*setTestFunctionUndefined)(Ark_NativePointer node,
                                     const Opt_CallbackNumberOptBoolean* value);
...
typedef struct GENERATED_ArkUITextInputModifier {
    ...
    void (*set_onChangeEvent_text)(Ark_NativePointer node,
                                   const CallbackResourceStrVoid* callback);
...
typedef struct GENERATED_ArkUITextPickerModifier {
    ...
    void (*setOnAccept)(Ark_NativePointer node,
                        const Opt_CallbackStringNumberVoid* callback_);
    void (*setOnCancel)(Ark_NativePointer node,
                        const Opt_CallbackVoid* callback_);
    void (*setOnChange)(Ark_NativePointer node,
                        const Opt_CallbackUnionStringArrayStringUnionNumberArrayNumberVoid* callback_);
    void (*setOnScrollStop)(Ark_NativePointer node,
    ...
    void (*setGradientHeight)(Ark_NativePointer node,
                              const Opt_Dimension* value);
    void (*set_onChangeEvent_selected)(Ark_NativePointer node,
                                       const CallbackUnionNumberArrayNumberVoid* callback);
    void (*set_onChangeEvent_value)(Ark_NativePointer node,
                                    const CallbackUnionStringArrayStringVoid* callback);
...
typedef struct GENERATED_ArkUIToggleModifier {
    ...
    void (*set_onChangeEvent_isOn)(Ark_NativePointer node,
                                   const CallbackBooleanVoid* callback);
...
typedef struct GENERATED_ArkUIWebModifier {
    ...
    void (*setOnNativeEmbedLifecycleChange)(Ark_NativePointer node,
                                            const Opt_CallbackNativeEmbedDataInfoVoid* callback_);
    void (*setOnRenderExited0)(Ark_NativePointer node,
                               const Opt_CallbackOnRenderExitedEventVoid* callback_);
    void (*setOnRenderExited1)(Ark_NativePointer node,
                               const Opt_CallbackOptLiteralObjectDetailBoolean* callback_);
    void (*setOnHttpErrorReceive)(Ark_NativePointer node,
                                  const Opt_CallbackOnHttpErrorReceiveEventVoid* callback_);
...
typedef struct GENERATED_ArkUIClickEventAccessor {
    ...
    void (*setY)(Ark_ClickEvent peer,
                 const Ark_Number* y);
    CallbackVoid (*getPreventDefault)(Ark_ClickEvent peer);
    void (*setPreventDefault)(Ark_ClickEvent peer,
                              const CallbackVoid* preventDefault);
...
typedef struct GENERATED_ArkUIContextAccessor {
    ...
    void (*getGroupDir)(Ark_VMContext vmContext,
                        ...
                        const CallbackOptStringOptArrayStringVoid* outputArgumentForReturningPromise);
...
typedef struct GENERATED_ArkUICustomSpanAccessor {
    ...
    AsyncCallbackCustomSpanMeasureInfoCustomSpanMetrics (*getOnMeasure)(Ark_CustomSpan peer);
    void (*setOnMeasure)(Ark_CustomSpan peer,
                         const AsyncCallbackCustomSpanMeasureInfoCustomSpanMetrics* onMeasure);
    CallbackDrawContextCustomSpanDrawInfoVoid (*getOnDraw)(Ark_CustomSpan peer);
    void (*setOnDraw)(Ark_CustomSpan peer,
                      const CallbackDrawContextCustomSpanDrawInfoVoid* onDraw);
...
typedef struct GENERATED_ArkUIDrawModifierAccessor {
    ...
    CallbackDrawContextVoid (*getDrawBehind)(Ark_DrawModifier peer);
    void (*setDrawBehind)(Ark_DrawModifier peer,
                          const CallbackDrawContextVoid* drawBehind);
    CallbackDrawContextVoid (*getDrawContent)(Ark_DrawModifier peer);
    void (*setDrawContent)(Ark_DrawModifier peer,
                           const CallbackDrawContextVoid* drawContent);
    CallbackDrawContextVoid (*getDrawFront)(Ark_DrawModifier peer);
    void (*setDrawFront)(Ark_DrawModifier peer,
                         const CallbackDrawContextVoid* drawFront);
...
typedef struct GENERATED_ArkUIHoverEventAccessor {
    ...
    Ark_NativePointer (*getFinalizer)();
    CallbackVoid (*getStopPropagation)(Ark_HoverEvent peer);
    void (*setStopPropagation)(Ark_HoverEvent peer,
                               const CallbackVoid* stopPropagation);
...
typedef struct GENERATED_ArkUIKeyEventAccessor {
    ...
    void (*setTimestamp)(Ark_KeyEvent peer,
                         Ark_Int64 timestamp);
    CallbackVoid (*getStopPropagation)(Ark_KeyEvent peer);
...
typedef struct GENERATED_ArkUILongPressGestureInterfaceAccessor {
    ...
    Ark_LongPressGestureInterface (*onAction)(Ark_LongPressGestureInterface peer,
                                              const CallbackGestureEventVoid* event);
...
typedef struct GENERATED_ArkUIMouseEventAccessor {
    ...
    void (*setY)(Ark_MouseEvent peer,
                 const Ark_Number* y);
    CallbackVoid (*getStopPropagation)(Ark_MouseEvent peer);
...
typedef struct GENERATED_ArkUINavPathInfoAccessor {
    ...
    Ark_NavPathInfo (*construct)(const Ark_String* name,
                                 ...
                                 const Opt_CallbackPopInfoVoid* onPop);
    Ark_NativePointer (*getFinalizer)();
    ...
    Opt_CallbackPopInfoVoid (*getOnPop)(Ark_NavPathInfo peer);
...
typedef struct GENERATED_ArkUINavPathStackAccessor {
    ...
    void (*pushDestination0)(Ark_VMContext vmContext,
                             ...
                             Ark_NavPathInfo info,
                             const Opt_Boolean* animated,
                             const CallbackOptArrayStringVoid* outputArgumentForReturningPromise);
    ...
    void (*pushPathByName1)(Ark_NavPathStack peer,
                            const Ark_String* name,
                            const Ark_Object* param,
                            const CallbackPopInfoVoid* onPop,
                            const Opt_Boolean* animated);
...
typedef struct GENERATED_ArkUIStyledStringAccessor {
    ...
    void (*fromHtml)(Ark_VMContext vmContext,
                     ...
                     const CallbackOptStyledStringOptArrayStringVoid* outputArgumentForReturningPromise);
...
typedef struct GENERATED_ArkUITouchEventAccessor {
    ...
    CallbackVoid (*getStopPropagation)(Ark_TouchEvent peer);
    void (*setStopPropagation)(Ark_TouchEvent peer,
                               const CallbackVoid* stopPropagation);
    CallbackVoid (*getPreventDefault)(Ark_TouchEvent peer);
...
typedef struct GENERATED_ArkUIUICommonEventAccessor {
    ...
    void (*setOnClick)(Ark_UICommonEvent peer,
                       const Opt_CallbackClickEventVoid* callback_);
    void (*setOnTouch)(Ark_UICommonEvent peer,
                       const Opt_CallbackTouchEventVoid* callback_);
    ...
    void (*setOnKeyEvent)(Ark_UICommonEvent peer,
                          const Opt_CallbackKeyEventVoid* callback_);
    ...
    void (*setOnMouse)(Ark_UICommonEvent peer,
                       const Opt_CallbackMouseEventVoid* callback_);
