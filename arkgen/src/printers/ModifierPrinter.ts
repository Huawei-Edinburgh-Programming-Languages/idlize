...
import { collapseIdlPeerMethods, collectComponents, collectDeclDependencies, componentToPeerClass, findComponentByDeclaration, findComponentByName, groupOverloads, ImportsCollector, peerGeneratorConfiguration, PrinterResult } from "@idlizer/libohos";
...
class ModifiersFileVisitor {
    ...
    printImports(peer: PeerClass): ImportsCollector {
        ...
        importsCollector.addFeature("AttributeModifier", "./component/common")
