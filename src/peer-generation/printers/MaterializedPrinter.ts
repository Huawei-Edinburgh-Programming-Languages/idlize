...
abstract class MaterializedFileVisitorBase implements MaterializedFileVisitor {
    ...
    protected printMaterializedClass(clazz: MaterializedClass) {
        ...
        if (!clazz.isInterface) {
            ...
            printer.writeClass(getInternalClassName(clazz.className), writer => writeFromPtrMethod(clazz, writer, classTypeParameters), undefined, undefined, undefined, undefined, false)
        } else {
