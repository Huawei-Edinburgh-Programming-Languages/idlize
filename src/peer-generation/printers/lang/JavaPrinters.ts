...
import { IdlSyntheticType } from "../../idl/IdlSyntheticType"
...
export function makeJavaArkComponents(library: PeerLibrary | IdlPeerLibrary, printerContext: PrinterContext): { targetFile: TargetFile, writer: LanguageWriter } {
    ...
    const imports = ['java.util.function.Consumer', 'java.util.function.Supplier']
    ...
    result.print(`package ${ARKOALA_PACKAGE};\n`)
    imports.forEach(module => result.print(`import ${module};\n`))
    result.concat(writer)
...
export class JavaUnion extends IdlSyntheticTypeBase {
    constructor(source: Object | undefined, public name: string, public readonly members: Type[], public readonly imports: string[]) {
        super(source)
    }

    print(writer: LanguageWriter): void {
        this.imports.forEach(module => writer.print(`import ${module};\n`))
...
export class JavaTuple extends IdlSyntheticTypeBase {
    constructor(source: Object | undefined, readonly name: string, public readonly members: Type[], public readonly imports: string[]) {
        super(source)
    }
