...
import { CJDeclarationConvertor, CJInterfacesVisitor } from './lang/CJInterfacePrinter'
...
export abstract class DefaultInterfacesVisitor implements InterfacesVisitor {
