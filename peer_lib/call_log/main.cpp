...
int main(int argc, const char** argv) {
  ...
  const Opt_SheetOptions var22_0 = {ARK_TAG_OBJECT, {{ARK_TAG_UNDEFINED, {}}, {ARK_TAG_OBJECT, {0, .value0={{1, .value1={.kind="NativeErrorResource", .id=0}}, {ARK_TAG_UNDEFINED, {}}}}}, {ARK_TAG_UNDEFINED, {}}}};
  ...
  const LabelStyle var3_1 = {{ARK_TAG_UNDEFINED, {}}};
