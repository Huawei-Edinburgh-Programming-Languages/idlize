...
KInt impl_TestCallIntKIntArraySum(KVMContext vmContext, KInt methodId, int32_t* arr, KInt length) {
...
KOALA_INTEROP_CTX_3(TestCallIntKIntArraySum, KInt, KInt, int32_t*, KInt)

void impl_TestCallVoidKIntArrayPrefixSum(KVMContext vmContext, KInt methodId, int32_t* arr, KInt length) {
...
KOALA_INTEROP_CTX_V3(TestCallVoidKIntArrayPrefixSum, KInt, int32_t*, KInt)
