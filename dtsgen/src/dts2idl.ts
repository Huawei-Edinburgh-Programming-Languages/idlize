...
import { peerGeneratorConfiguration, IDLVisitorConfiguration, groupOverloadsTS } from "@idlizer/libohos"
...
export class IDL2DTSVisitor implements GenerateVisitor<idl.IDLFile> {
